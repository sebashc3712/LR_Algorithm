...
public:
  ...
  enum IntParam {
    ...
    OptimalityTarget  = CPX_PARAM_OPTIMALITYTARGET,  /**< = CPX_PARAM_OPTIMALITYTARGET */
    SolutionTarget    = CPX_PARAM_SOLUTIONTARGET,  /**< = CPX_PARAM_SOLUTIONTARGET @deprecated since V12.6.2 */
...
#include <ilcplex/iloparam.h>
  ...
  enum OptimalityTargetType {
    OptimalityAuto          = CPX_OPTIMALITYTARGET_AUTO,          /**< = CPX_OPTIMALITYTARGET_AUTO */
    OptimalityOptimalConvex = CPX_OPTIMALITYTARGET_OPTIMALCONVEX, /**< = CPX_OPTIMALITYTARGET_OPTIMALCONVEX */
    OptimalityFirstOrder    = CPX_OPTIMALITYTARGET_FIRSTORDER,    /**< = CPX_OPTIMALITYTARGET_FIRSTORDER */
    OptimalityOptimalGlobal = CPX_OPTIMALITYTARGET_OPTIMALGLOBAL  /**< = CPX_OPTIMALITYTARGET_OPTIMALGLOBAL */
  };
